...
export const GC_OBJECT_BASE_URL_MAP = {
  ...
  "interaction-widget":
    "/directory/#/admin/integrations/apps/embedded-client-app-interaction-widget/",
  ...
  "ws-data-actions":
    "/directory/#/admin/integrations/apps/custom-rest-actions/",
  "gc-data-actions":
    "/directory/#/admin/integrations/apps/purecloud-data-actions/",
};
