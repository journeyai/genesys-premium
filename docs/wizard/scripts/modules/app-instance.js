...
async function getExisting() {
  ...
  let _getIntegrations = async (pageNum) => {
    ...
    data.entities
      .filter((entity) => {
        return (
          entity.integrationType.id == config.premiumAppIntegrationTypeId &&
    ...
    let integrationConfig = {
      body: {
        ...
        properties: {
          ...
          featureCategory: "",
          groupFilter: appInstanceInstall.groups
    ...
    promisesArr.push(
      (async () => {
        try {
          ...
          const patchData = await integrationsApi.patchIntegration(
            appInstance.id,
            opts
          );
