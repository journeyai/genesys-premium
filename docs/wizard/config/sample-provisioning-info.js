let sample = {
  role: [
    {
      name: "Admin",
      description:
        "Admins will be able to access the Premium App installation wizard and make changes to the configurations.",
    ...
    },
    {
      name: "Agent",
      description:
        "Agents have access to a widget that gives US state information based on caller's number.",
      permissions: ["premium_app_permission"],
      assignToSelf: true,
    },
  ],
  ...
  "oauth-client": [
    ...
    },
    {
      ...
      description:
        "Generated Client that's used by the App FrontEnd and the App Backend",
      registeredRedirectUri: ["https://replace_this_url/some_path/index.html"],
      scope: ["user-basic-info", "analytics", "search:readonly"],
  ...
  "event-bridge": [
    {
      ...
      eventFilter: [
        "v2.analytics.flow.{id}.aggregates",
        "v2.analytics.users.{id}.aggregates",
        "v2.architect.dependencytracking.build",
      ],
    },
  ],
};
